...
bpDF.to_excel(os.path.join(derivatives, 'bp_DEG_lists.xlsx'))
...
mddDF.to_excel(os.path.join(derivatives, 'mdd_DEG_lists.xlsx'))
...
"""
replacing code with operationalized code above
"""
#%% create dictionary containing only brain diseases of interest
"""
identify genes present in xenium data that are also present in:
