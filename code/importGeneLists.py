...
adHippDF.to_excel(os.path.join(derivatives, 'ad_hipp_bulkRNASeq_DEG_lists.xlsx'), index=False)
...
adCortDF.to_excel(os.path.join(derivatives, 'ad_cort_bulkRNASeq_DEG_lists.xlsx'), index=False)
...
writer = pd.ExcelWriter(os.path.join(derivatives, 'ad_cort_snRNASeq_DEG_lists.xlsx'))
